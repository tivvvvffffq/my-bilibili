...
import com.nxj.bilibili.dao.VideoDao;
import com.nxj.bilibili.domain.*;
import com.nxj.bilibili.domain.exception.ConditionException;
import com.nxj.bilibili.service.util.FastDFSUtil;
import com.nxj.bilibili.service.util.ImageUtil;
import com.nxj.bilibili.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.nxj.bilibili.domain.File file = fileService.getFileByMd5(fileMd5);
        ...
        int ffLength = fFmpegFrameGrabber.getLengthInFrames(); // 总帧数
        Frame frame;

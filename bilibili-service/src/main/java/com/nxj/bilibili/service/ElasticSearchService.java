...
import com.nxj.bilibili.dao.repository.UserInfoRepository;
import com.nxj.bilibili.dao.repository.VideoRepository;
...
public class ElasticSearchService {
    ...
    public List<Map<String, Object>> getContents(String keyword,
        ...
        MultiMatchQueryBuilder matchQueryBuilder = QueryBuilders.multiMatchQuery(keyword, "title", "nick", "description"); // 多条件
